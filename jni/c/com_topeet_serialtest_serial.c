 ...
 * Signature: ()[I
 */
JNIEXPORT jintArray JNICALL Java_com_topeet_serialtest_serial_Read(JNIEnv *env,
		jobject obj) {
 ...
 * Signature: ()[I
 */
JNIEXPORT jintArray JNICALL Java_com_topeet_serialtest_serial_Write(JNIEnv *env,
